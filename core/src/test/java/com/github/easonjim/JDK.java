...
public class JDK {
    ...
    public static void setEnv(final Map<String, String> newenv) {
        try {
            ...
            @SuppressWarnings("unchecked") final Map<String, String> env = (Map<String, String>) theEnvironmentField
                    .get(null);
            ...
            @SuppressWarnings("unchecked") final Map<String, String> cienv = (Map<String, String>) theCaseInsensitiveEnvironmentField
                    .get(null);
